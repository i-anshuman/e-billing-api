...
const { signupSchema, signinSchema } = require('../validators/account');
const { watchErrors } = require('../middlewares');
const { signup, signin } = require('../controllers/account');
const { sign, verify } = require('../controllers/jwt');

router.post('/signup', watchErrors(signupSchema, "body"), (req, res) => {
...
router.post('/signin', watchErrors(signinSchema, "body"), (req, res) => {
